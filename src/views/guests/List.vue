  ...
  <div class="container text-left">
    <item-list
      ...
      <template #customControlsPre="props">
        <b-button v-if="props.item.sound" size="sm" class="ml-1" v-b-modal.sound-player variant="primary" @click="playerSound = props.item.sound.name" v-b-tooltip="{ title: 'Play', variant: 'primary' }" pill><b-icon class="mb-1 mt-1" icon="play"></b-icon></b-button>
      </template>
